...
MSRVTT_res_path = os.path.join(opt.test_and_inference_res,'noun',backbone,'MSRVTT') # 存放MSRVTT的inference result的路径
MSVD_res_path = os.path.join(opt.test_and_inference_res,'noun',backbone,'MSVD') # 存放MSVD的inference result的路径
