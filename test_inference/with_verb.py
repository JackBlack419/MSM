...
MSRVTT_res_path = os.path.join(opt.test_and_inference_res,'verb',backbone,'MSRVTT') # 存放MSRVTT的inference result的路径
MSVD_res_path = os.path.join(opt.test_and_inference_res,'verb',backbone,'MSVD') # 存放MSVD的inference result的路径
